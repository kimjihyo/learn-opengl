...
/*
    ...
    Cmdline:
        sokol-shdc --input assets/shaders/test.glsl --output assets/shaders/test.glsl.h --slang glsl300es --format sokol_impl
...
*/
static const uint8_t vs_source_glsl300es[93] = {
